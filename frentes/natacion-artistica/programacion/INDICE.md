...
| [`02-programacion/progresiones-por-patron.md`](02-programacion/progresiones-por-patron.md) | ✅ | P1–P6, de lo más fácil a lo más difícil, con el criterio técnico para avanzar. **Los seis validados por Daniel** (2026-08-06 y 07). Ninguna prueba oficial de la batería queda sin progresión. Pendiente solo el ajuste de los criterios numéricos con la línea base |
